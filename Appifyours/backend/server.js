...
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/yireh_app', {
...
app.get('/api/app-config', async (req, res) => {
  ...
  try {
    ...
    const config = {
      ...
      adminId: '69c524deed334f3809e3e589',
...
app.listen(PORT, () => {
  ...
  console.log(`yireh Backend Server running on port ${PORT}`);
